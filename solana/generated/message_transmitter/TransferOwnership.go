...
func (inst *TransferOwnership) SetMessageTransmitterAccount(messageTransmitter ag_solanago.PublicKey) *TransferOwnership {
...
func (inst *TransferOwnership) GetMessageTransmitterAccount() *ag_solanago.AccountMeta {
