...
// ReplaceMessage is the `replaceMessage` instruction.
...
// NewReplaceMessageInstructionBuilder creates a new `ReplaceMessage` instruction builder.
func NewReplaceMessageInstructionBuilder() *ReplaceMessage {
	nd := &ReplaceMessage{
...
func (inst *ReplaceMessage) SetParams(params ReplaceMessageParams) *ReplaceMessage {
	inst.Params = &params
	return inst
}

// SetEventRentPayerAccount sets the "eventRentPayer" account.
func (inst *ReplaceMessage) SetEventRentPayerAccount(eventRentPayer ag_solanago.PublicKey) *ReplaceMessage {
...
func (inst *ReplaceMessage) GetEventRentPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetSenderAuthorityPdaAccount sets the "senderAuthorityPda" account.
func (inst *ReplaceMessage) SetSenderAuthorityPdaAccount(senderAuthorityPda ag_solanago.PublicKey) *ReplaceMessage {
...
func (inst *ReplaceMessage) GetSenderAuthorityPdaAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetMessageTransmitterAccount sets the "messageTransmitter" account.
func (inst *ReplaceMessage) SetMessageTransmitterAccount(messageTransmitter ag_solanago.PublicKey) *ReplaceMessage {
...
func (inst *ReplaceMessage) GetMessageTransmitterAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetMessageSentEventDataAccount sets the "messageSentEventData" account.
func (inst *ReplaceMessage) SetMessageSentEventDataAccount(messageSentEventData ag_solanago.PublicKey) *ReplaceMessage {
...
func (inst *ReplaceMessage) GetMessageSentEventDataAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetSenderProgramAccount sets the "senderProgram" account.
func (inst *ReplaceMessage) SetSenderProgramAccount(senderProgram ag_solanago.PublicKey) *ReplaceMessage {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(senderProgram)
	return inst
}

// GetSenderProgramAccount gets the "senderProgram" account.
func (inst *ReplaceMessage) GetSenderProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *ReplaceMessage) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *ReplaceMessage {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *ReplaceMessage) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

func (inst ReplaceMessage) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_ReplaceMessage,
	}}
}
...
func (inst ReplaceMessage) ValidateAndBuild() (*Instruction, error) {
...
func (inst *ReplaceMessage) Validate() error {
...
func (inst *ReplaceMessage) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("ReplaceMessage")).
				//
...
func (obj ReplaceMessage) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *ReplaceMessage) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Params`:
...
// NewReplaceMessageInstruction declares a new ReplaceMessage instruction with the provided parameters and accounts.
func NewReplaceMessageInstruction(
	...
	systemProgram ag_solanago.PublicKey) *ReplaceMessage {
	return NewReplaceMessageInstructionBuilder().
		SetParams(params).
