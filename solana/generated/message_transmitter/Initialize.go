...
func (inst *Initialize) GetMessageTransmitterAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetMessageTransmitterProgramDataAccount sets the "messageTransmitterProgramData" account.
func (inst *Initialize) SetMessageTransmitterProgramDataAccount(messageTransmitterProgramData ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(messageTransmitterProgramData)
	return inst
}

// GetMessageTransmitterProgramDataAccount gets the "messageTransmitterProgramData" account.
func (inst *Initialize) GetMessageTransmitterProgramDataAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetMessageTransmitterProgramAccount sets the "messageTransmitterProgram" account.
func (inst *Initialize) SetMessageTransmitterProgramAccount(messageTransmitterProgram ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(messageTransmitterProgram)
	return inst
}

// GetMessageTransmitterProgramAccount gets the "messageTransmitterProgram" account.
func (inst *Initialize) GetMessageTransmitterProgramAccount() *ag_solanago.AccountMeta {
...
func (inst *Initialize) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		if inst.AccountMetaSlice[3] == nil {
			return errors.New("accounts.MessageTransmitterProgramData is not set")
		}
			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=8]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("messageTransmitterProgramData", inst.AccountMetaSlice.Get(3)))
						accountsBranch.Child(ag_format.Meta("    messageTransmitterProgram", inst.AccountMetaSlice.Get(4)))
...
func NewInitializeInstruction(
	...
	messageTransmitterProgramData ag_solanago.PublicKey,
	...
	return NewInitializeInstructionBuilder().
		...
		SetMessageTransmitterProgramDataAccount(messageTransmitterProgramData).
