...
func (inst *Pause) SetTokenMinterAccount(tokenMinter ag_solanago.PublicKey) *Pause {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(tokenMinter).WRITE()
	return inst
}

// GetTokenMinterAccount gets the "tokenMinter" account.
func (inst *Pause) GetTokenMinterAccount() *ag_solanago.AccountMeta {
