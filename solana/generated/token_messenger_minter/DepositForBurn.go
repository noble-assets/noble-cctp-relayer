...
// DepositForBurn is the `depositForBurn` instruction.
...
// NewDepositForBurnInstructionBuilder creates a new `DepositForBurn` instruction builder.
func NewDepositForBurnInstructionBuilder() *DepositForBurn {
	nd := &DepositForBurn{
...
func (inst *DepositForBurn) SetParams(params DepositForBurnParams) *DepositForBurn {
	inst.Params = &params
	return inst
}

// SetOwnerAccount sets the "owner" account.
func (inst *DepositForBurn) SetOwnerAccount(owner ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(owner).SIGNER()
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *DepositForBurn) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetEventRentPayerAccount sets the "eventRentPayer" account.
func (inst *DepositForBurn) SetEventRentPayerAccount(eventRentPayer ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetEventRentPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetSenderAuthorityPdaAccount sets the "senderAuthorityPda" account.
func (inst *DepositForBurn) SetSenderAuthorityPdaAccount(senderAuthorityPda ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetSenderAuthorityPdaAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetBurnTokenAccountAccount sets the "burnTokenAccount" account.
func (inst *DepositForBurn) SetBurnTokenAccountAccount(burnTokenAccount ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetBurnTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetMessageTransmitterAccount sets the "messageTransmitter" account.
func (inst *DepositForBurn) SetMessageTransmitterAccount(messageTransmitter ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetMessageTransmitterAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenMessengerAccount sets the "tokenMessenger" account.
func (inst *DepositForBurn) SetTokenMessengerAccount(tokenMessenger ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(tokenMessenger)
	return inst
}

// GetTokenMessengerAccount gets the "tokenMessenger" account.
func (inst *DepositForBurn) GetTokenMessengerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetRemoteTokenMessengerAccount sets the "remoteTokenMessenger" account.
func (inst *DepositForBurn) SetRemoteTokenMessengerAccount(remoteTokenMessenger ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetRemoteTokenMessengerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenMinterAccount sets the "tokenMinter" account.
func (inst *DepositForBurn) SetTokenMinterAccount(tokenMinter ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(tokenMinter)
	return inst
}

// GetTokenMinterAccount gets the "tokenMinter" account.
func (inst *DepositForBurn) GetTokenMinterAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetLocalTokenAccount sets the "localToken" account.
func (inst *DepositForBurn) SetLocalTokenAccount(localToken ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(localToken).WRITE()
	return inst
}

// GetLocalTokenAccount gets the "localToken" account.
func (inst *DepositForBurn) GetLocalTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetBurnTokenMintAccount sets the "burnTokenMint" account.
func (inst *DepositForBurn) SetBurnTokenMintAccount(burnTokenMint ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(burnTokenMint).WRITE()
	return inst
}

// GetBurnTokenMintAccount gets the "burnTokenMint" account.
func (inst *DepositForBurn) GetBurnTokenMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetMessageSentEventDataAccount sets the "messageSentEventData" account.
func (inst *DepositForBurn) SetMessageSentEventDataAccount(messageSentEventData ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetMessageSentEventDataAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetMessageTransmitterProgramAccount sets the "messageTransmitterProgram" account.
func (inst *DepositForBurn) SetMessageTransmitterProgramAccount(messageTransmitterProgram ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetMessageTransmitterProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetTokenMessengerMinterProgramAccount sets the "tokenMessengerMinterProgram" account.
func (inst *DepositForBurn) SetTokenMessengerMinterProgramAccount(tokenMessengerMinterProgram ag_solanago.PublicKey) *DepositForBurn {
...
func (inst *DepositForBurn) GetTokenMessengerMinterProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *DepositForBurn) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *DepositForBurn) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *DepositForBurn) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *DepositForBurn) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

// SetEventAuthorityAccount sets the "eventAuthority" account.
func (inst *DepositForBurn) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[15] = ag_solanago.Meta(eventAuthority)
	return inst
}

// GetEventAuthorityAccount gets the "eventAuthority" account.
func (inst *DepositForBurn) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(15)
}

// SetProgramAccount sets the "program" account.
func (inst *DepositForBurn) SetProgramAccount(program ag_solanago.PublicKey) *DepositForBurn {
	inst.AccountMetaSlice[16] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *DepositForBurn) GetProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(16)
}

func (inst DepositForBurn) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_DepositForBurn,
	}}
}
...
func (inst DepositForBurn) ValidateAndBuild() (*Instruction, error) {
...
func (inst *DepositForBurn) Validate() error {
...
func (inst *DepositForBurn) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("DepositForBurn")).
				//
...
func (obj DepositForBurn) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *DepositForBurn) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Params`:
...
// NewDepositForBurnInstruction declares a new DepositForBurn instruction with the provided parameters and accounts.
func NewDepositForBurnInstruction(
	...
	program ag_solanago.PublicKey) *DepositForBurn {
	return NewDepositForBurnInstructionBuilder().
		SetParams(params).
