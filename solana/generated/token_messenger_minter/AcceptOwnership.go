...
func (inst *AcceptOwnership) SetTokenMessengerAccount(tokenMessenger ag_solanago.PublicKey) *AcceptOwnership {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(tokenMessenger).WRITE()
	return inst
}

// GetTokenMessengerAccount gets the "tokenMessenger" account.
func (inst *AcceptOwnership) GetTokenMessengerAccount() *ag_solanago.AccountMeta {
